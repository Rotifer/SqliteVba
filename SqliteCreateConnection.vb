...
Private Const m_connStrTemplate As String = "DRIVER=SQLite3 ODBC Driver;Database=[PATH_TO_DATABASE_FILE];LongNames=0;Timeout=1000;NoTXN=0;SyncPragma=NORMAL;StepAPI=0;"
